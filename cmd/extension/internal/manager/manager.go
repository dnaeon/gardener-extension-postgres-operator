...
import (
	...
	"github.com/gardener/gardener-extension-postgres-operator/pkg/actuator"
	configinstall "github.com/gardener/gardener-extension-postgres-operator/pkg/apis/config/install"
	"github.com/gardener/gardener-extension-postgres-operator/pkg/controller"
	"github.com/gardener/gardener-extension-postgres-operator/pkg/heartbeat"
	"github.com/gardener/gardener-extension-postgres-operator/pkg/mgr"
)
	...
	cmd := &cli.Command{
		...
		Flags: []cli.Flag{
			&cli.StringFlag{
				...
				Value:       "gardener-extension-postgres-operator",
			...
			&cli.StringFlag{
				...
				Value:       "gardener-extension-postgres-operator-leader-election",
