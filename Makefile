...
IMAGE ?= europe-docker.pkg.dev/gardener-project/public/gardener/extensions/gardener-extension-postgres-operator

# Name and version of the Gardener extension.
EXTENSION_NAME ?= gardener-extension-postgres-operator
